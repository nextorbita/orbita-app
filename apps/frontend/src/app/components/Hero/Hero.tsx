...
const Hero = () => {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex min-h-screen w-full max-w-[1480px] flex-col px-6 pb-12 pt-24 md:px-10 md:pt-28 lg:px-16 lg:pt-32">
          <div className="mx-auto flex w-full max-w-[1200px] grow flex-col items-center justify-center pt-16 text-center md:pt-20">
            ...
            <div className="mt-12 flex w-full max-w-[560px] flex-col items-center justify-center gap-4 sm:flex-row sm:gap-5">
              <a
                href="#services"
                className="inline-flex min-h-[64px] w-full items-center justify-center rounded-2xl bg-[#9df74d] px-8 text-lg font-medium text-[#2b2b2a] transition-transform duration-400 hover:-translate-y-0.5 sm:w-[260px] hover:border-[#FEFDEC] hover:text-[#FEFDEC] hover:bg-blue-400"
              >
                {t("Hero.ctaMore")}
              </a>
              <a
                href="#contact-form"
                className="inline-flex min-h-[64px] w-full items-center justify-center rounded-2xl bg-[#FEFDEC] px-8 text-lg font-medium text-[#2b2b2a] transition-colors duration-400 hover:text-[#FEFDEC] hover:-translate-y-0.5 hover:bg-blue-400 sm:w-[260px]"
              >
                {t("Hero.ctaContact")}
              </a>
            </div>
      ...
      {/* Companies Icons Section */}
      <section className="relative isolate overflow-hidden bg-[#282828] text-[#f0f0ec] py-15 md:py-25">
        <div className="mx-auto grid w-full max-w-[760px] grid-cols-1 items-center gap-8 px-6 opacity-60 sm:grid-cols-2 sm:gap-14">
          ...
          <div className="grid w-full grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="flex flex-col gap-8">
              {aboutParagraphs.map((paragraph) => (
                <p
                  key={paragraph}
                  className="text-lg leading-relaxed text-[#deded7]"
                >
                  {paragraph}
                </p>
              ))}
            ...
            {teamMembers.map((member, index) => {
              const teamImages = [
                ...
                },
                {
                  ...
                  imgClassName: "h-70 w-full object-cover",
                },
              ];
        ...
        <div className="mx-auto flex w-full max-w-[1180px] flex-col items-center gap-16 px-6 md:px-10 lg:px-16">
          ...
          <div className="flex w-full flex-col gap-6">
            {portfolioItems.map((item, index) => {
              const hrefs = [
                "https://www.vivaldimkt.com/",
                "https://www.dictumtranslationsolutions.com/",
                null,
              ];
              const href = hrefs[index];
              const linkClassName =
                "w-full rounded-xl bg-[#efefe8] px-6 py-3 font-semibold text-[#2b2b2a] transition-colors duration-200 hover:bg-[#deded7] md:w-auto md:flex-shrink-0 inline-flex items-center justify-center";

              return (
                <div
                  key={item.title}
                  className="rounded-3xl border-2 border-[#FEFDEC] bg-transparent p-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between"
                >
          ...
          <div className="flex w-full flex-col gap-4">
            {faqItems.map((item) => {
              ...
              return (
                <div
                  key={item.question}
                  className="rounded-xl border-2 border-[#FEFDEC] p-6"
                >
                  <button
                    type="button"
